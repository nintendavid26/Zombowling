...
public class FadeObjectInOut : MonoBehaviour
{
    ...
    {
        float maxAlpha = 0.0f;
        Renderer rendererObjects = GetComponent<Renderer>();
        maxAlpha = Mathf.Max(maxAlpha, rendererObjects.material.color.a);
        return maxAlpha;
    }
    ...
    IEnumerator FadeSequence(float fadingOutTime)
    {
        ...
        while ((alphaValue >= 0.0f && fadingOut) || (alphaValue <= 1.0f && !fadingOut))
        {
            alphaValue += Time.deltaTime * fadingOutSpeed;
                ...
                Color newColor = (colors != null ? colors[0] : rendererObject.material.color);
                newColor.a = Mathf.Min(newColor.a, alphaValue);
                newColor.a = Mathf.Clamp(newColor.a, 0.0f, 1.0f);
                rendererObject.material.SetColor("_Color", newColor);
